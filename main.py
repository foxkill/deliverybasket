...
# bond
#
from rateslib import FixedRateBond, BondFuture, dt

def main():
    print(f'Yield: 0.1930   Conv: 0.9233   Gro/Bas: {61.356/32} Impl Repo: -4.599   Act Repo: 0.172   Net/Bas: {45.960/32}\n')
    ...
    df = usbf.dlv(
        ...
        # prices=[102+(29.5/32), 103+(25.875/32), 103+(3.625/32), 102+(25.625/32), 103+(16.875/32), 103 + (6.25/32), 103 + (4.5/32), 103 + (3/32)],
